...
<template>
  ...
  >
    ...
    <div class="navbar-center">
      <NuxtLink to="/">
        <a class="btn btn-ghost normal-case text-4xl text-gray-800 dark:text-gray-200"
          >Zhenlei's Blog</a
        >
      </NuxtLink>
    </div>
      ...
      <div class="flex">
        <div class="flex-auto">
          ...
          <div class="space-x-4 hidden lg:flex lg:mr-2">
            <HomeMenuItem :is-scrolled="isScrolled" to="/blogs">
              <span>blogs</span>
            </HomeMenuItem>
            <!--        <MenuItem-->
            ...
            <!--          showcases-->
            <!--        </MenuItem>-->
            <HomeMenuItem :is-scrolled="isScrolled" to="/contact">
              <span>contact</span>
            </HomeMenuItem>
            <ThemeSelect />
          </div>
